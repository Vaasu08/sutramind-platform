...
public sealed record ProtocolInput(string Version, string ModernDiagnosis, string VyadhiCode, string InterventionName, Guid? MedicineId, string DosageFormCode, string AnupanaCode, int TreatmentDurationDays);
