...
public sealed record EnrollParticipantRequest(string ParticipantCode, Guid StudyId, Guid SiteId, string Name, int Age, string Gender, string ModernDiagnosis, string VyadhiCode, int? DiseaseDurationMonths, string? RandomizationId, DateOnly EnrollmentDate, AyurvedaBaselineInput Baseline);
